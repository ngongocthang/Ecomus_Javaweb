                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${categoryList}" var="category">
                                                <tr>
                                                    ...
                                                    <td><img style="width: 75px; height: 75px;  object-fit: cover;" src="${pageContext.request.contextPath}/storage/${category.thumbnail}" alt="alt"/></td>
                                                    <td>${category.name}</td>
                                                    <td><a href="EditCategoryServlet?categoryId=${category.id}" style="color: orange;"><i class="fa fa-edit me-2"></i></a></td>
                                                    <td>
