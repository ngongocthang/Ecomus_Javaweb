                        ...
                        <div class="col-12">
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <form action="EditCategoryServlet" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <img style="width: 100px; height: 100px; margin-bottom: 5px;" src="${pageContext.request.contextPath}/storage/${category.thumbnail}" alt="alt"/>
                                        <br>
                                    ...
                                    <a href="IndexCategoryServlet" class="btn btn-secondary">Cancel</a>
