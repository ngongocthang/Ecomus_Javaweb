                        ...
                        <div class="col-12">
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <form action="EditProductServlet" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <img style="width: 100px; height: 100px; margin-bottom: 5px;" src="${pageContext.request.contextPath}/storage/${product.thumbnail}" alt="alt"/>
                                        <br>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="price" type="number" value="${product.price}" class="form-control" id="exampleInputPassword1">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Quantity</label>
                                        <input name="quantity" type="number" value="${product.quantity}" class="form-control" id="exampleInputPassword1">
                                    </div>
                                    <div class="mb-3">
