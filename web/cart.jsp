...
<div id="wrapper">
    ...
    <c:if test="${empty cart}">
        <div class="tf-page-cart text-center mt_140 mb_200">
            ...
            <a href="ShopServlet" class="tf-btn btn-sm radius-3 btn-fill btn-icon animate-hover-btn">Return to shop<i class="icon icon-arrow1-top-left"></i></a>
        </div> 
    </c:if> 
                                                                                                                ...
                                                                                                                <div class="card-product">
                                                                                                                    <div class="card-product-wrapper">
                                                                                                                        <a href="ProductServlet?productId=${product.id}" class="product-img">
                                                                                                                            <img class="lazyload img-product" data-src="${pageContext.request.contextPath}/storage/${product.thumbnail}" src="${pageContext.request.contextPath}/storage/${product.thumbnail}" alt="image-product">
                                                                                                                                <img class="lazyload img-hover" data-src="${pageContext.request.contextPath}/storage/${product.thumbnail}" src="${pageContext.request.contextPath}/storage/${product.thumbnail}" alt="image-product">
                                                                                                                                    </a>
                                                                                                                                    <div class="list-product-btn absolute-2">
                                                                                                                                        <a href="ProductServlet?productId=${product.id}"  class="box-icon bg_white quickview tf-btn-loading">
