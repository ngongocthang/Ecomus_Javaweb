...
<section class="flat-spacing-2">
    <div class="container">
        ...
        <ul class="tf-pagination-wrap tf-pagination-list">
            <c:if test="${page > 1}">
                <li>
                    <a href="CategoryServlet?categoryId=${category.id}&page=${page - 1}" class="pagination-link animate-hover-btn">
            ...
            <c:forEach var="i" begin="1" end="${numberPage}">
                <c:if test="${i == page}">
                    <li class="active">
                        <a href="CategoryServlet?categoryId=${category.id}&page=${i}" class="pagination-link">${i}</a>
                    </li>
                </c:if>
                <c:if test="${i != page}">
                    <li>
                        <a href="CategoryServlet?categoryId=${category.id}&page=${i}" class="pagination-link animate-hover-btn">${i}</a>
                    </li>
                </c:if>
            </c:forEach>
...
<div class="offcanvas offcanvas-start canvas-filter" id="filterShop">
    <div class="canvas-wrapper">
        ...
        <div class="canvas-body">
            ...
            <form action="CategoryServlet" method="get" id="facet-filter-form" class="facet-filter-form">
